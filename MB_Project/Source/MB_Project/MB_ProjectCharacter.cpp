...
void AMB_ProjectCharacter::NotifyControllerChanged()
{
...
void AMB_ProjectCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
...
void AMB_ProjectCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
